...
<body>
    ...
    <h2>Questionário</h2>
    <form action="cadastro_solucao_2.php" method="post" class="form-group">
        ...
        <div id="territorio-container">
            ...
            <div class="territorio">
                ...
                <input type="text" id="nometerritorio_1" name="nometerritorio_1" placeholder="Qual o nome do território?" required><br>
                <br>
        ...
        <div id="atividades-container">
            ...
            <div class="atividade">
                ...
                <label for="remocao_1">6.5) Fora os roçados, as comunidades precisam retirar floresta pra implantar/realizar as atividades?</label>
        ...
        <!------------------------------------------ QUESTÃO 16 --------------------------------------- -->
        <label for="estrategia_implementada">16) A associação utiliza Instrgram, Facebbok ou sites para divulgação dos produtos e atividades?</label>
        ...
        <select id="preservacao_cultural" name="preservacao_cultural" required>
            ...
            <option value="A cultura é possui risco de desaparecer">A cultura é possui risco de desaparecer</option>
