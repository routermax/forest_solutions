...
try
{
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO solucao (
                origem, cd_responsavel, cd_contato, cd_entidade, uf, municipio, familias_beneficiadas,
                ...
                dependencia_finaceira_externa, mudanca_meio_ambiente, desafios, melhorias, data_coleta,
                beneficiosFinal, beneficioOutro, renda, beneficioAmbiental, regeneracao, aumentodiversidade, reducaoEmissoes,
                localizacao, coordenadas, tipo_territorio, agua_qualidade, educacaambiental, emregeneracao, lideranca
            ) VALUES (
                :origem, :cd_responsavel, :cd_contato, :cd_entidade, :uf, :municipio, :familias_beneficiadas,
                :nome_territorio, :internet_qualidade, :energia_qualidade, :energia_fonte, :agua_fonte,
                :acesso_meio, :acesso_qualidade, :capacitacao_implementada, :capacitacao_interesse,
