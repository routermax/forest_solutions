...
<body>
    ...
    <form action="cadastro_produto.php" method="post" class="form-group"">
        <input type="hidden" name="submit_cadastrar" value="1">
        <h3>A) Informações do Produto/Serviço</h3>

        <label for="nome">1) Nome do Produto/Serviço:</label>
        <input type="text" id="nome" name="nome"  required>
        
        <label for="cnpj">2) Sistema Produtivo:</label>
        <input type="text" id="sistema" name="sistema" />

        <label for="historico">3) Descrição:</label>
        <textarea id="descricao" name="descricao" ></textarea><br>
      
        <label for="cep">4) Tipo:</label>
        <input type="text" id="tipo" name="tipo">       

        <label for="endereco">5) Sub-tipo:</label>
        <input type="text" id="sub_tipo" name="sub_tipo" />  
        ...
        <label for="atividade">6) Atividade:</label>
