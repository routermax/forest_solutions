...
<head>
    ...
    ?>
<body>
    <div id="termo-container"></div>

    <?php
        //$resposavelNome = 'Márcio Silva';
        include 'termo_de_uso.php';
    ?>
    ...
    <form action="cadastro_solucao.php" method="post" class="form-group">
        ...
        <input type="text" id="origem" name="origem" value="Questionário" readonly required><br>
        ...
        <script>
            ...
            .then(data => {
                ...
                data.forEach(responsavel => {
                    ...
                    document.getElementById("nome-pesquisador").textContent = responsavel.nome;
                    document.getElementById("contato-pesquisador").textContent = responsavel.contato;
                });
            })
            .catch(error => console.error("Erro ao carregar contatos:", error));

            const cd_contato = urlParams.get('tk3');
            fetch(`get_contatos.php?cd=${cd_contato}`)
            .then(response => response.json())
            .then(data => {
                //console.log("Dados recebidos:", data);
                ...
                data.forEach(contato => {
                    ...
                    document.getElementById("nome-contato").textContent = contato.nome;
                });
            })
            .catch(error => console.error("Erro ao carregar contatos:", error));
