...
try {
    ...
    $sql = "SELECT cd_atividade, nome, categoria, sub_categoria, metodo, descricao from atividade               
            ORDER BY nome ";
...
<div class="container-fluid mt-4">
    <h2 class="text-center">Lista de Atividades</h2>
    ...
    <table id="tabela" class="display table table-bordered" width="100%">
        ...
        <tbody>
            <?php foreach ($dados as $linha) { ?>
                <tr>
                    <td><?php echo htmlspecialchars($linha['cd_atividade']); ?></td>
                    <td><?php echo htmlspecialchars($linha['nome']); ?></td>
                    <td><?php echo htmlspecialchars($linha['descricao']); ?></td>
                    <td><?php echo htmlspecialchars($linha['categoria']); ?></td>
                    <td><?php echo htmlspecialchars($linha['sub_categoria']); ?></td>
                    <td><?php echo htmlspecialchars($linha['metodo']); ?></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
