...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="mobile-view w-full max-w-sm p-6 bg-white shadow-lg rounded-xl text-center">
        ...
        <div class="flex gap-4">
            ...
            <a href="#" class="w-1/5 bg-green-600 text-white font-semibold text-lg py-4 rounded-lg mb-4 shadow-md hover:bg-green-700 text-center">
                🔍 
            </a>
        </div>
    </div>
    ...
    <div class="desktop-view w-full max-w-3xl p-10 bg-white shadow-lg rounded-xl text-center">
        ...
        <div class="flex gap-4">
            ...
            <a href="#" class="w-1/5 bg-green-600 text-white font-semibold text-xl py-6 rounded-lg shadow-md hover:bg-green-700 text-center">
                🔍 
            </a>
        </div>
    </div>
