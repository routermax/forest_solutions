...
<div style="display: flex; justify-content: center; margin: 20px 0;">
    <button id="mostrarTCLEBtn" onclick="mostrarTCLE()">Mostrar TCLE</button>
        ...
        <div class="form-group">
            ...
            <input type="text" id="origem" name="origem" value="<?= htmlspecialchars($solucao['origem']) ?>"  />
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="nome_responsavel" name="nome_responsavel" value="<?= htmlspecialchars($solucao['nome_responsavel']) ?>"  />
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="entidade" name="entidade" value="<?= htmlspecialchars($solucao['nome_entidade']) ?>"  />
        </div>

        <div class="form-group">
            <label for="entidade">1.1) Nome do contato da entidade:</label>
            <input type="text" id="nome_contato" name="nome_contato" value="<?= htmlspecialchars($solucao['nome_contato']) ?>"  />
        </div>

        <div class="form-group">
            <label for="familias_beneficiadas">2) Quantas famílias estão envolvidas?:</label>
            <input type="text" id="familias_beneficiadas" name="familias_beneficiadas" value="<?= htmlspecialchars($solucao['familias_beneficiadas']) ?>" >
        </div>

        <div class="form-group">
            <label for="nome_territorio">3) Categoria fundiária (velha):</label>
            <input type="text" id="tipo_territorio" name="tipo_territorio" value="<?= htmlspecialchars($solucao['tipo_territorio']) ?>"  />
        </div>

        <div class="form-group">
            <label for="nome_territorio">3.1) Nome do território (velha):</label>
            <input type="text" id="nome_territorio" name="nome_territorio" value="<?= htmlspecialchars($solucao['nome_territorio']) ?>" >
        </div>
        ...
        <div class="form-group">
            ...
            <?php foreach ($territorios as $territorio): ?>
                ...
                <input type="text" id="tipo" name="tipo" value="<?= htmlspecialchars($territorio['tipo']) ?>" >
                <label for="nome">Nome :</label>
                <input type="text" id="nome" name="nome" value="<?= htmlspecialchars($territorio['nome']) ?>" >
                <?php $indiceT++; ?>
                <?php echo '<tr></td>';?>
            <?php endforeach; ?>
        ...
        <div class="form-group">
            ...
            <input type="text" id="Estado" name="Estado" value="<?= htmlspecialchars($solucao['estado']) ?>" >
        </div>

        <div class="form-group">
            <label for="Municipio">5) Município:</label>
            <input type="text" id="Municipio" name="Municipio" value="<?= htmlspecialchars($solucao['cidade']) ?>" >
        </div>
        ...
        <div class="form-group">
            ...
            <?php foreach ($produtos as $produto): ?>
                ...
                <input type="text" id="ProdutosServiços" name="ProdutosServiços" value="<?= htmlspecialchars($produto['nome']) ?>" >
                <label for="produtoServico">Produto/Serviço :</label>
                <input type="text" id="ProdutosServiços" name="ProdutosServiços" value="<?= htmlspecialchars($produto['nome_produto_servico']) ?>" >
                <label for="remocaoFlorestal">Remoção florestal :</label>
                <input type="text" id="ProdutosServiços" name="ProdutosServiços" value="<?= htmlspecialchars($produto['remocao_florestal']) ?>" >
                <?php $indice++; ?>
                <?php echo '<tr></td>';?>
            <?php endforeach; ?>
        ...
        <div class="form-group">
            ...
            <input type="text" id="internet_qualidade" name="internet_qualidade" value="<?= htmlspecialchars($solucao['internet_qualidade']) ?>" >
        </div>

        <div class="form-group">
            <label for="energia_qualidade">8) Qualidade de energia:</label>
            <input type="text" id="energia_qualidade" name="energia_qualidade" value="<?= htmlspecialchars($solucao['energia_qualidade']) ?>" >
        </div>

        <div class="form-group">
            <label for="energia_fonte">9) Fonte de energia:</label>
            <input type="text" id="energia_fonte" name="energia_fonte" value="<?= htmlspecialchars($solucao['energia_fonte']) ?>" >
        </div>

        <div class="form-group">
            <label for="agua_qualidade">10) Qualidade da água:</label>
            <input type="text" id="agua_qualidade" name="agua_qualidade" value="<?= htmlspecialchars($solucao['agua_qualidade']) ?>" >
        </div>

        <div class="form-group">
            <label for="agua_fonte">11) Fonte de água:</label>
            <input type="text" id="agua_fonte" name="agua_fonte" value="<?= htmlspecialchars($solucao['agua_fonte']) ?>" >
        </div>

        <div class="form-group">
            <label for="acesso_meio">12) Meio de acesso:</label>
            <input type="text" id="acesso_meio" name="acesso_meio" value="<?= htmlspecialchars($solucao['acesso_meio']) ?>" >
        </div>

        <div class="form-group">
            <label for="acesso_qualidade">13) Qualidade de acesso:</label>
            <input type="text" id="acesso_qualidade" name="acesso_qualidade" value="<?= htmlspecialchars($solucao['acesso_qualidade']) ?>" >
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="capacitacao_implementada" name="capacitacao_implementada" value="<?= htmlspecialchars($solucao['capacitacao_implementada']) ?>"  />
        </div>

        <div class="form-group">
            <label for="conflitos_locais">15) Tecnologia iplementada:</label>
            <input type="text" id="tecnologia_implementada" name="tecnologia_implementada" value="<?= htmlspecialchars($solucao['tecnologia_implementada']) ?>"  />
        </div>

        <div class="form-group">
            <label for="conflitos_locais">16) Estratégia implementada:</label>
            <input type="text" id="estrategia_implementada" name="estrategia_implementada" value="<?= htmlspecialchars($solucao['estrategia_implementada']) ?>"  />
        </div>

        <div class="form-group">
            <label for="conflitos_locais">17) Engajamento comunitário:</label>
            <input type="text" id="engajamento_comunitario" name="engajamento_comunitario" value="<?= htmlspecialchars($solucao['engajamento_comunitario']) ?>"  />
        </div>

        <div class="form-group">
            <label for="conflitos_locais">18) Preservação cultural:</label>
            <input type="text" id="preservacao_cultural" name="preservacao_cultural" value="<?= htmlspecialchars($solucao['preservacao_cultural']) ?>"  />
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="conflitos_locais" name="conflitos_locais" value="<?= htmlspecialchars($solucao['conflitos_locais']) ?>" >
        </div>

        <div class="form-group">
            <label for="vontade_mudanca">20) Vontade de mudança:</label>
            <input type="text" id="vontade_mudanca" name="vontade_mudanca" value="<?= htmlspecialchars($solucao['vontade_mudanca']) ?>" >
        </div>

        <div class="form-group">
            <label for="dependencia_finaceira_externa">21) Dependência financeira externa:</label>
            <input type="text" id="dependencia_finaceira_externa" name="dependencia_finaceira_externa" value="<?= htmlspecialchars($solucao['dependencia_finaceira_externa']) ?>" >
        </div>

        <div class="form-group">
            <label for="mudanca_meio_ambiente">22) Mudanças no meio ambiente:</label>
            <input type="text" id="mudanca_meio_ambiente" name="mudanca_meio_ambiente" value="<?= htmlspecialchars($solucao['mudanca_meio_ambiente']) ?>" >
        </div>

        <div class="form-group">
            <label for="desafios">23) Desafios:</label>
            <textarea id="desafios" name="desafios" ><?= htmlspecialchars($solucao['desafios']) ?></textarea>
        </div>

        <div class="form-group">
            <label for="melhorias">24) Melhorias sugeridas:</label>
            <textarea id="melhorias" name="melhorias" ><?= htmlspecialchars($solucao['melhorias']) ?></textarea>
        </div>
            ...
            <?php
                ...
                foreach ($beneficios as $beneficio) {
                    if (!empty($beneficio)) { // Verifica se o benefício não está vazio
                        if ($beneficio == 'Outro') {
                            echo '<input type="text" class="beneficio-input" value="Outro: ' . htmlspecialchars($solucao['beneficiooutro']) . '"  /><br>';
                        } else {
                            echo '<input type="text" class="beneficio-input" value="' . htmlspecialchars($beneficio) . '"  /><br>';
                        }
                    }
                }
            ?>
        ...
        <div class="form-group">
            <label for="mudanca_meio_ambiente">26) Redna suficiente:</label>
            <input type="text" id="renda" name="renda" value="<?= htmlspecialchars($solucao['renda']) ?>"  />
        </div>

        <div class="form-group">
            <label for="mudanca_meio_ambiente">27) Beneficio Ambiental:</label>
            <input type="text" id="beneficioAmbiental" name="beneficioAmbiental" value="<?= htmlspecialchars($solucao['beneficioambiental']) ?>"  />
        </div>

        <div class="form-group">
            <label for="mudanca_meio_ambiente">28) Regeneracao de áreas degradadas:</label>
            <input type="text" id="regeneracao" name="regeneracao" value="<?= htmlspecialchars($solucao['regeneracao']) ?>"  />
        </div>

        <div class="form-group">
            <label for="aumentodiversidade">29) Aumento da diversidade:</label>
            <input type="text" id="aumentodiversidade" name="aumentodiversidade" value="<?= htmlspecialchars($solucao['aumentodiversidade']) ?>"  />
        </div>

        <div class="form-group">
            <label for="reducaoEmissoes">30) Reducao de Emissoes:</label>
            <input type="text" id="reducaoEmissoes" name="reducaoEmissoes" value="<?= htmlspecialchars($solucao['reducaoemissoes']) ?>"  />
        </div>

        <div class="form-group">
            <label for="educacaambiental">31) Conscientização ambiental:</label>
            <input type="text" id="educacaambiental" name="educacaambiental" value="<?= htmlspecialchars($solucao['educacaambiental']) ?>"  />
        </div>

        <div class="form-group">
            <label for="lideranca">32) Maioria da lideranças:</label>
            <input type="text" id="lideranca" name="lideranca" value="<?= htmlspecialchars($solucao['lideranca']) ?>"  />
        </div>
