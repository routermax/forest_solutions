...
<head>
    ...
    <title>Cadastro encerrado</title>
...
<body>
    <div class="success-container">
        ...
        <div class="success-message">
            Termo de consentimento recusado!
        </div>
        <!-- Descrição adicional -->
        <div class="success-description">
            Seu cadastro não pode prosseguir sem o aceite do TCLE. Agradecemos por participar de nossa pesquisa.
        </div>
    </div>
    <br>
</body>
